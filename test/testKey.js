...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var dtoKey, daoKey, resutls2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dtoKey = new DTOKey_1.DTOKey();
                    daoKey = new MDBDAOKey_1.MDBDAOKey();
                    console.log("Comienza pruebas de DAO key");
                    dtoKey.setIdFile("bbbbbbbbbb");
                    dtoKey.setIdType(KeyConstants_1.KeyConstants.KEY_INTEGRITY);
                    dtoKey.setKeyFileName("alo.dcr");
                    dtoKey.setKeyHash("idjkamd");
                    return [4 /*yield*/, daoKey.findKeyByFileIdAndType("bbbbbbbbbb", KeyConstants_1.KeyConstants.KEY_CIPHER_DECIPHER)];
                case 1:
                    resutls2 = _a.sent();
